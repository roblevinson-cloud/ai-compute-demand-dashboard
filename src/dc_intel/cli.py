...
def _parser() -> argparse.ArgumentParser:
    ...
    sub.add_parser("seed-demo-db", help="Upsert the evidence-backed national portfolio into PostgreSQL")
    ...
    build = sub.add_parser("build-demo", help="Build the evidence-backed national intelligence dashboard")
